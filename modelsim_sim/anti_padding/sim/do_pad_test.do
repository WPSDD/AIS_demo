...
vlog	-work base_space	./tb_pad_test.v
vlog	-work design		./../design/*.v
#vlog	-work altera_lib	./altera_lib/*.v

vsim	 -voptargs=+acc	-L base_space -L design base_space.tb_pad_test
...
add wave	-divider {tb_pad_test}
add wave	tb_pad_test/*
add wave	-divider {pad_test}
add wave	tb_pad_test/pad_test_inst/*
